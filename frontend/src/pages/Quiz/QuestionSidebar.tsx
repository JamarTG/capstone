...
const QuestionSidebar: FC<QuestionSidebarProps> = ({
  ...
  return (
    <div
      className={`w-full sm:w-1/4 lg:w-1/3 p-4 ${isDark ? "bg-gray-800" : ""} rounded-lg sticky top-16 h-full overflow-y-auto`}
    >
      <h2 className="text-xl text-white mb-6">Questions</h2>
      <ul className="space-y-4">
        <RenderList data={pageQuestions} renderFn={renderPageQuestion} />
      </ul>

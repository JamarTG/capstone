...
const TopicCard = ({ topic, onClick }: { topic: Topic; onClick: () => void }) => (
  <Card
    ...
    className="w-70 h-20 border border-gray-200 rounded-lg relative flex flex-col min-h-[10rem] bg-white overflow-hidden p-0 transition-all duration-300 group"
    style={{

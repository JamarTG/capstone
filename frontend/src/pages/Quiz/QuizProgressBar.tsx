...
const QuizProgressBar: FC<QuizProgressBarProps> = ({
  ...
  return (
    <div className={`p-4 rounded-lg ${isDark ? "bg-gray-800" : "bg-white"}`}>
      <div
        className={`flex items-center justify-between text-sm mb-2 ${isDark ? "text-gray-300" : "text-slate-600"}`}
      >
      ...
      <div
        className={`h-2 ${isDark ? "bg-gray-700" : "bg-slate-600/30"} rounded-full`}
      >
        <div

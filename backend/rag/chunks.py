...
def sectionTwoSyllabus():
    ...
    """, """Description: Explain the interrelationship among key Web technology concepts.
...
def sectionThreeSyllabus():
    ...
    """, """Description: Describe suitable countermeasures to mitigate effects of identified threats.
    ...
    """, """Description: Assess the effect of automation on job security.
    Content: Job loss vs productivity gains in skilled and unskilled job categories.
    """, """Description: Describe the roles of various personnel in computer-related professions.
    ...
    """, """Description: Assess the impact of information and communications technology on select fields.
...
def sectionFourSyllabus():
    chunks=["""Description: Create a document using content from a range of sources.
    Content: Importing text (combining documents). Typewritten text, images and other objects.
    """, """Description: Use appropriate document formatting features.
    ...
    """, """Description: Use appropriate editing features to structure and organize a document.
    ...
    """, """Description: Use the review feature of a word processor to enhance document readiness.
    Content: Spell and grammar check, thesaurus, word count, language setting, comments, and track changes.
    """, """Description: Appropriately use features that allow the protection of a document.
    Content: Automatic save and backup copy, edit restrictions – password protection.
    """, """Description: Generate a table of contents for a document.
    Content: Auto table of content.
    """, """Description: Use the mail merge feature in the preparation of a document for a variety of situations.
    Content: Creation of primary documents and data files in mail merge application. Field names.
    """, """Description: Create a fillable electronic form for online use.
    Content: Use of content controls, such as check boxes, text boxes, date picker, drop-down lists, and command buttons.
    """, """Description: Plan a website structure and organization of a web page.
    ...
    """, """Description: Create simple web pages using a variety of design features. (The use of HTML coding is not required.)
    ...
    """, """Description: Insert hyperlinks within different locations of a typical web page.
    ...
    """,  """Description: Evaluate a website for accuracy, user friendliness and effective display.
...
def sectionFiveSyllabus():
    chunks=["""Description: Explain the purpose of a spreadsheet.
    ...
    """, """Description: Manipulate data in a spreadsheet.
    ...
    """, """Description: Perform charting operations.
    ...
    """, """Description: Manipulate one or more worksheets.
...
def sectionSixSyllabus():
    chunks=["""Description: Explain the concept of a database.
    ...
    """, """Description: Use terminology commonly associated with a database.
    ...
    """, """Description: Manipulate data in a database.
...
def sectionSevenSyllabus():
    chunks=["""Description: Outline the steps in problem-solving.
    ...
    ""","""Description: Use the divide-and-conquer approach to decompose large everyday problems into smaller tasks.
    Content: Basic treatment of the structured approach for solving complex problems. (Note: It is not necessary to give a detailed treatment of the approach. Simple illustrations can be provided to help students recognize that most problems involve multiple tasks and that they should understand how to approach such problems in a structured manner.)""",
     """Description: Define a problem by decomposing it into its significant components.
    Content: The components are: input; process; and output. A defining diagram (IPO Chart) may be used to delineate the components.
    """, """Description: Distinguish between variables and constants.
    ...
    """, """ Description: Represent algorithms in the form of flowchart and pseudocode.
    Content: Use of flowchart symbols: input/output, process, decision, start/stop. directional arrows, Pseudocode: Use of read, input, store, write, print, output, display, conditional branching (if-then, if-then-else, nested conditions); loops (for, while, repeat). Use of relational operators: <, >, =, <=, > =,< >. Logical operators: AND, OR, NOT; use of truth tables. Arithmetic operators: +‚ –‚ *, , MOD, DIV.
...
def sectionEightSyllabus():
    chunks=["""Description: Distinguish between low-level and high level programming languages.
    Content: Low-level language (Machine or Assembly). High-level language (For example, Visual Basic, Pascal, C).
    """, """Description: Describe the sequence of steps in implementing a program.
    ...
    """, """Description: Perform checks and tests on programs to verify correctness.
    Content: Errors: syntax, logic, runtime. Testing (test data). Debugging techniques.
    """, """Description: Declare variables and constants using elementary data types.
    Content: Data types: integer, real/double/float, character, string and Boolean/logical.
    """, """Description: Translate algorithmic statements into high-level language syntax.
    ...
    """, """Description: Effectively document programs.
